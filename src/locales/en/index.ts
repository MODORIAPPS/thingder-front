export default {
    ...
    about: {
        ...
        asktotalk: "I have something to say 💬",
        desc1: "How do we see each other when we get out of Tinder? What have we been watching on Tinder?",
        desc2: "Experience online dating where the body is replaced by ready-made products and humanity is replaced by materiality. Things that were blurry may look less blurry. It might look more blurry 😯",
        desc3: "And then one day, when you open Tinder again, you might see something else 👾"
    },
    desc: {
        welcome: "Welcome ❣️"
    },
